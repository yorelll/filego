...
impl Msg {
    pub fn id(self) -> &'static str {
        match self {
            ...
            Msg::MonoNoticeExportTargetExists => "settings.notice.export_target_exists",
...
pub const ALL_KEYS: &[&str] = &[
    ...
    "settings.notice.export_target_exists",
...
mod en_us {
    ...
    pub const CATALOG: &[(&str, &str)] = &[
        ...
        (
            "settings.notice.export_target_exists",
            "Target file exists; not overwritten",
        ),
